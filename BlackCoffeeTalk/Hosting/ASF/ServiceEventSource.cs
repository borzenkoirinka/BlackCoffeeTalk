...
{
    [EventSource(Name = "MyCompany-BlackCoffeeTalk.AsfService-BlackCoffeeTalk")]
    internal sealed class ServiceEventSource : ApplicationEventSource
    {
        ...
        public void ServiceMessage(ServiceContext serviceContext, string message, params object[] args)
        {
            if (this.IsEnabled())
            {
                ...
                ServiceMessage(
                    ...
                    ((StatelessServiceContext)serviceContext).InstanceId,
